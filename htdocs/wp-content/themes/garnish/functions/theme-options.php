...
$options[] = array( "name" => __('Site Description','framework'),
					"desc" => __('Enter in your site description.','framework'),
...
$options[] = array( "name" => __('Select the page you\'re using as a blog','framework'),
...
$options[] = array( "name" => __('Footer Copy','framework'),
					"desc" => __('This will display in the bottom right of the footer.','framework'),
...
$options[] = array( "name" => __('Respond Caption','framework'),
					"desc" => __('This snippet will display near the comment respond form.','framework'),
...
$options[] = array( "name" => "",
					"message" => __('Setup the display of your homepage. Choose to enable the Magic Door and which item to open upon page load.','framework'),
					"type" => "intro");
					
$options[] = array( "name" => __('Enable the Magic Door','framework'),
					"desc" => __('Check this to enable the usage of the magic door. If disabled, the portfolio items will link to their respective pages.','framework'),
					"id" => $shortname."_magic_door",
					"std" => "false",
					"type" => "checkbox");
					
$options[] = array( "name" => __('Portfolio Post to Open With','framework'),
					"desc" => __('Input the ID of the portfolio post you wish to open the door with, if left empty the door will be closed. This will only work if the Magic door is enabled.','framework'),
					"id" => $shortname."_magic_door_state",
					"std" => "",
					"type" => "text");

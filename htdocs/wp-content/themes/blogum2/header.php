...
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?php bloginfo('text_direction'); ?>" xml:lang="<?php bloginfo('language'); ?>">
    <head>
        ...
        <link rel="shortcut icon" href="<?php bloginfo('template_url'); ?>/images/em.ico" type="image/x-icon" />
        ...
        <link rel="stylesheet" href="http://f.fontdeck.com/s/css/D8Fz3XWt+VC0VDejQHe7Mks5Qzc/www.adroot.co.uk/5960.css" type="text/css" />
        <?php
